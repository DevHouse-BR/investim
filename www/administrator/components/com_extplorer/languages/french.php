...
$GLOBALS["error_msg"] = array(
	...
	"searchnothing"	=> "Vous devez entrez un élément à chercher.",
...
$GLOBALS["messages"] = array(
	...
	"miscshowhidden"		=> "Voir les éléments cachés",
	"mischidepattern"		=> "Cacher pattern",
	"miscperms"				=> "Permissions",
	"miscuseritems"			=> "(nom, répertoire home, Voir les éléments cachés, permissions, actif)",
	...
	'sidirpermsmess'	=> 'Pour obtenir un fonctionnement total, assurez vous que vous possèdez les droits en écriture sur les répertoires et fichiers (chmod). Vous pouvez vous connecter en FTP pour modifier ces droits',
