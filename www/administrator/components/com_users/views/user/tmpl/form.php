...
?>
				...
				<tr>
					...
					<td>
						<input class="inputbox" type="text" name="empresa" id="empresa" size="40" value="<?php echo $this->user->get('empresa'); ?>" />
					</td>
				</tr>
				<tr>
					<td class="key">
				...
				<tr>
					...
					<td>
						<input class="inputbox" type="text" name="cidade" id="cidade" size="40" value="<?php echo $this->user->get('cidade'); ?>" />
					</td>
				</tr>
				<tr>
					<td class="key">
				...
				<tr>
					...
					<td>
						<input class="inputbox" type="text" name="telefone" id="telefone" size="40" value="<?php echo $this->user->get('telefone'); ?>" />
					</td>
				</tr>
				<tr>
					<td class="key">
					...
					<td>
						<input class="inputbox" type="text" name="celular" id="celular" size="40" value="<?php echo $this->user->get('celular'); ?>" />
					</td>
				</tr>
				<tr>
					<td class="key">
					...
					<td>
						<input class="inputbox" type="text" name="skype" id="skype" size="40" value="<?php echo $this->user->get('skype'); ?>" />
					</td>
				</tr>
				<tr>
					<td class="key">
					...
					<td>
						<input class="inputbox" type="text" name="msn" id="msn" size="40" value="<?php echo $this->user->get('msn'); ?>" />
					</td>
				</tr>
				<tr>
					<td class="key">
