	...
	<tr>
		<td align="left"  width="100%">
			...
			<?php echo $this->lists['state']; ?>
             ...
             <td nowrap="nowrap" align="right">
            <?php echo Filter::FilterFeatured( $this->items[0],'featured','subproducts' ); ?>
            </td>
...
$link 		= JRoute::_( 'index.php?option='.$option.'&view='.$view.'&layout=form&task=edit&cid[]='. $row->id);	
	...
	?>
		<tr class="<?php echo "row$k"; ?>">
            ...
            <td>
            <?php $img_path = JURI::root().'images/properties/subproducts/peques/peque_'.$row->image1;?>
...
<img border=&quot;1&quot; src=&quot;<?php echo $img_path; ?>&quot; name=&quot;imagelib&quot; alt=&quot;<?php echo JText::_( 'No preview available'.$img_path ); ?>&quot; width=&quot;200&quot; height=&quot;150&quot; />">
				<img width="30" src="<?php echo JURI::root().'images/properties/subproducts/peques/peque_'.$row->image1;?>" />
                </span>
                
			</td>
            
<td>
          <?php $img_path = JURI::root().'images/properties/subproducts/'.$row->image1;?>
