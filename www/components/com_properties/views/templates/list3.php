...
<div align="center" class="topagent">
...
<?php if($this->DataAgent->locality){echo JText::_('State').' : '.$this->DataAgent->state.'<br />';} ?>
<?php if($this->DataAgent->locality){echo JText::_('Country').' : '.$this->DataAgent->country.'<br />';} ?>
</div>
...
if($PositionPrice==0){
echo JText::_('Price').': <strong>'.$SimbolPrice.' '. $formatted_price.'</strong>'; 
}else{
echo JText::_('Price').': <strong>'.$formatted_price .' '. $SimbolPrice.'</strong>';
}

}else{
echo '<b><font color="#FF0000"> '. JTEXT::_('Call for price').'</font></b><br />';
}
?> 
</div>
...
<a class="ListObjectBoxBottomlnkDetail" href="<?php echo $link ;?>"><?php echo JText::_('View details'); ?></a>

<a class="linkBookingButton" href="<?php echo $link ;?>"><?php echo JText::_('Book now'); ?></a>
...
<img class="foto" width="<?php echo $WidthThumbsAccordion; ?>" height="<?php echo $HeightThumbsAccordion; ?>" src="<?php echo $rout_thumb.$image->name; ?>" alt="<?php echo str_replace('"',' ',$row->name); ?>"/></a>
...
<?php if($row->extra1){echo '<tr><td class="td_left">'.JText::_('Extra1').' :</td><td class="td_right">'. JText::_('Extra1_'.$row->extra1).'</td></tr>';} ?>
