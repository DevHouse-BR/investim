...
<div class="productdetail" style="width:100%; float:left; margin:0px !important;">
<?php
...
<table border="0">
<tr>
<td width="250px" valign="top" class="img_big_details">
...
<td width="250px" valign="top" style="padding-left:20px;">


<table style="padding-left:20px;" border="0" class="table_details">
<tr><td colspan="2">
...
<table width="100%"class="table_description" >
<tr>
...
<img style="padding:2px; border: 1px solid #CCCCCC;" width="<?php echo $WidthThumbsDetail; ?>" height="<?php echo $HeightThumbsDetail; ?>" src="<?php echo $rout_thumb.$image->name; ?>" alt="<?php echo str_replace('"',' ',$Product->name); ?>"/></a>
...
<div class="apartments_availables" style="text-align:center; font-size:14px; margin-top:20px;">
<?php echo JText::_('List apartments availables');?>
</div>
<?php  
...
<div class="product_detail" style="width:100%; float:left; margin:0px !important;">
<?php
...
<table style="margin-left:20px;" border="0" class="table_details">
<tr><td colspan="2">
<div class="tituloProduct" style="float:left; font-weight:bold;"><?php echo $Product->name;?></div>
</td></tr>
<?php //echo $showprice; ?>
...
<?php if($Product->extra1){echo '<tr><td class="td_left">'.JText::_('Extra1').' :</td><td class="td_right">'. JText::_('Extra1_'.$Product->extra1).'</td></tr>';} ?>
...
<?php if($Product->extra41){echo '<tr><td align="right">'.JText::_('extra41') .':</td><td align="left">'.  $Product->extra41 .'</td></tr>';} ?>
                    ...
                    <table id="tableDuplexCalendarLegend">
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo JText::_('Available').', '. JText::_('Start day');?></td>
                            
                                <td class="tdArrivalNotPossible img">&nbsp;</td>
                                <td><?php echo JText::_('Available').' '. JText::_('no start day');?></td>
                            
                                <td class="tdSelectedDates img">&nbsp;</td>

                                <td><?php echo JText::_('Selected dates');?></td>
                           
                                <td class="tdBooked img">&nbsp;</td>
                                <td><?php echo JText::_('Not available');?></td>
                            </tr>
                        </tbody>
                    </table> 
...
<table style=" margin-top:10px;" class="footer_price_list" align="justify" border="0">
<tr>
<td colspan="3" align="justify" style="text-align:justify;">
<?php echo JText::_('TOPCALENDARTEXT');?>
</td>
</tr>       
</table> 
...
<table class="admintable" width="100%">
	<tr>
    	<td colspan="2">
        <?php //if($row->extra81){echo '<tr><td colspan="2">'.  $row->extra81 .'</td></tr>';} ?>
        </td>
    </tr>
</table>

<table style="" class="colorstripes" align="center" border="0" width="100%">
<thead> 
<tr><td colspan="3" align="center" class="title_price_list">
<?php echo JText::_('PRICE LIST SUMMER YEAR');?>
</td>
</tr> 
<tr>
<!--<th style="text-align: center;">Title</th>-->
<th style="text-align: center;"><?php echo JText::_('Period of travel');?></th>
<th style="text-align: center;"><?php echo JText::_('Price');?></th>
...
<tr>
<td colspan="3" align="justify" style="text-align:justify;">
<?php echo JText::_('FOOTERPRICELIST_ID'.$Product->id);?>
</td>
</tr>       
</table>
