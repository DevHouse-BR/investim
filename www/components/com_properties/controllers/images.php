...
$this->publish	= ( $this->getTask() == 'publish' ? 1 : 0 );		
		...
		$link = 'index.php?option=com_properties&view=panel&task=editimages&product_id='.$product_id;
...
$WidthImage=$params->get('WidthImage',800);
$HeightImage=$params->get('HeightImage',600);
...
$Itemid = JRequest::getVar( 'Itemid' );
	...
	$this->setRedirect( 'index.php?option=com_properties&view=panel&task=editimages&product_id='.$post['parent']);
				break;	
...
foreach($cids as $cid) {
		...
		$this->setRedirect( 'index.php?option=com_properties&view=panel&task=editimages&product_id='.$product_id, $msg );
	}
