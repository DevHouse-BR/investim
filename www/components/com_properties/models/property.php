...
$breadcrumbs->addItem( "Voltar", 'Javascript: history.back();' );
...
$link = LinkHelper::getLink('properties','showcategory','','','','',$this->_dataCategory->Cslug,'','');
...
$link = LinkHelper::getLink('properties','showcategory','','','','',$this->_dataCategory->Cslug,$this->_dataType->Tslug,'');
