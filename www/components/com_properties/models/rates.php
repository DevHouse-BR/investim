...
function _buildQuery()
	...
	if($this->filter_product){
		$where[] = 'r.productid = '.$this->filter_product;
		}elseif(JRequest::getVar('product_id')){
		$where[] = 'r.productid = '.JRequest::getVar('product_id');
...
$this->filter_order		= null;
		...
		$this->filter_product		= $mainframe->getUserStateFromRequest( "$option.filter_product",		'filter_product',		'',		'int' );
