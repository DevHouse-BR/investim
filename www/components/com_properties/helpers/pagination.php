...
class JPagination extends JObject{
	...
	function getPagesLinks()
	{
		...
		$chromePath = JPATH_COMPONENT.DS.'includes'.DS.'pagination.php';
	...
	function orderUpIcon($i, $condition = true, $task = 'orderup', $alt = 'Move Up', $enabled = true)
	{
		...
		if (($i > 0 || ($i + $this->limitstart > 0)) && $condition)
		{
			if($enabled) {
				...
				$html	.= '   <img src="http://localhost/property30/components/com_properties/includes/img/uparrow.png" width="16" height="16" border="0" alt="'.$alt.'" />';
				$html	.= '</a>';
			} else {
				$html	= '<img src="http://localhost/property30/components/com_properties/includes/img/uparrow0.png" width="16" height="16" border="0" alt="'.$alt.'" />';
			}
		}
