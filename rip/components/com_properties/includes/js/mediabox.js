...
var Mediabox = {
	init: function(options){
		this.options = Object.extend({
			...
			initialWidth: 360,
			initialHeight: 360,
			defaultWidth: 405,			// Default width (px)
			defaultHeight: 305,			// Default height(px)
			animateCaption: true,		// This is not smooth animation in IE 6 with XML prolog.
										// If your site is XHTML strict with XML prolog, disable this option.
		// Mediaplayer settings and options
			playerpath: 'jw_media_player/mediaplayer.swf',	// Path to the mediaplayer.swf or flvplayer.swf file
